...
#   db_subnet_group_name = "hr-staging-sosotech-cluster-db-us-east-1a"  # Make sure you create this before manually
...
#   engine = "aurora-postgresql"
#   engine_version = "11.16"
#   db_subnet_group_name = "hr-staging-sosotech-cluster-db-us-east-1b"
...
resource "aws_db_instance" "rds_instance" {
  ...
  "final_snapshot_identifier = foo"    #added this just because i had issues with destroying...not required here
